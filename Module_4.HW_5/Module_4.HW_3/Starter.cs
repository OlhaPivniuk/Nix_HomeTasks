...
namespace Module_4.HW_5
{
    public class Starter
    {
        public void Run()
        {
            ...
            var connectionString = configuration.GetConnectionString("Module_4.HW_5");
            ...
            applicationContext.Employee.Add(new Entities.Employee { TitleId = 2, EmployeeProject = employeeProject, DateOfBirth = new DateTime(1995, 01, 20), FirstName = "Andrey", LastName = "Kudryashov", HiredDate = new DateTime(2019, 11, 10), OfficeId = 1 });
