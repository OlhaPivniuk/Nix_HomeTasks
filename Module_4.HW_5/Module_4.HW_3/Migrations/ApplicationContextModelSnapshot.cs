...
namespace Module_4.HW_5.Migrations
{
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Module_4.HW_5.Entities.Client", b =>
            {
                ...
                b.HasData(
                    ...
                    new
                    {
                        ClientId = 5,
                        Age = 42,
                        Email = "timofiy.kurchenko@outlook.com",
                        FirstName = "Timofiy",
                        LastName = "Kurchenko"
                    });
            });

            modelBuilder.Entity("Module_4.HW_5.Entities.Employee", b =>
            {
            ...
            modelBuilder.Entity("Module_4.HW_5.Entities.EmployeeProject", b =>
            {
            ...
            modelBuilder.Entity("Module_4.HW_5.Entities.Office", b =>
            {
                b.Property<int>("OfficeId")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("int")
            ...
            modelBuilder.Entity("Module_4.HW_5.Entities.Project", b =>
            {
                b.Property<int>("ProjectId")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("int")
            ...
            modelBuilder.Entity("Module_4.HW_5.Entities.Title", b =>
            {
                b.Property<int>("TitleId")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("int")
            ...
            modelBuilder.Entity("Module_4.HW_5.Entities.Employee", b =>
            {
                b.HasOne("Module_4.HW_5.Entities.Office", "Office")
                    .WithMany("Employees")
                    .HasForeignKey("OfficeId")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired();

                b.HasOne("Module_4.HW_5.Entities.Title", "Title")
                    .WithMany("Employees")
            ...
            modelBuilder.Entity("Module_4.HW_5.Entities.EmployeeProject", b =>
            {
                b.HasOne("Module_4.HW_5.Entities.Employee", "Employee")
                    .WithMany("EmployeeProject")
                    .HasForeignKey("EmployeeId")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired();

                b.HasOne("Module_4.HW_5.Entities.Project", "Project")
                    .WithMany("EmployeeProject")
            ...
            modelBuilder.Entity("Module_4.HW_5.Entities.Project", b =>
            {
                b.HasOne("Module_4.HW_5.Entities.Client", "Client")
                    .WithMany("Projects")
