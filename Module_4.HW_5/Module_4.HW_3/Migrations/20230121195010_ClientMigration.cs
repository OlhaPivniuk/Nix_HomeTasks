    ...
    public partial class ClientCreateProjectRemade : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 45, "o.pivniuk@gmail.com", "Olha", "Pivniuk" },
                    { 2, 24, "ivan24@gmail.com", "Ivan", "Kovalenko" },
                    { 3, 65, "vashenko65@gmail.com", "Stepan", "Vashenko" },
                    { 4, 23, "tetianka45@ukr.net", "Tetiana", "Noveniuk" },
                    { 5, 42, "timofiy.kurchenko@outlook.com", "Timofiy", "Kurchenko" }
                });
