...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Module_4.HW_3.Entities.Client", b =>
            {
            ...
            modelBuilder.Entity("Module_4.HW_3.Entities.Employee", b =>
            {
            ...
            modelBuilder.Entity("Module_4.HW_3.Entities.EmployeeProject", b =>
            {
            ...
            modelBuilder.Entity("Module_4.HW_3.Entities.Office", b =>
            {
                b.Property<int>("OfficeId")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("int")
            ...
            modelBuilder.Entity("Module_4.HW_3.Entities.Project", b =>
            {
                b.Property<int>("ProjectId")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("int")
            ...
            modelBuilder.Entity("Module_4.HW_3.Entities.Title", b =>
            {
                b.Property<int>("TitleId")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("int")
            ...
            modelBuilder.Entity("Module_4.HW_3.Entities.Employee", b =>
            {
                b.HasOne("Module_4.HW_3.Entities.Office", "Office")
                    .WithMany("Employees")
                    .HasForeignKey("OfficeId")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired();

                b.HasOne("Module_4.HW_3.Entities.Title", "Title")
                    .WithMany("Employees")
            ...
            modelBuilder.Entity("Module_4.HW_3.Entities.EmployeeProject", b =>
            {
                b.HasOne("Module_4.HW_3.Entities.Employee", "Employee")
                    .WithMany("EmployeeProject")
                    .HasForeignKey("EmployeeId")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired();

                b.HasOne("Module_4.HW_3.Entities.Project", "Project")
                    .WithMany("EmployeeProject")
            ...
            modelBuilder.Entity("Module_4.HW_3.Entities.Project", b =>
            {
                b.HasOne("Module_4.HW_3.Entities.Client", "Client")
                    .WithMany("Projects")
